            ...
            if ser.in_waiting:
                ...
                while b"\n" in buf:
                    ...
                    if n == "pendant":
                        ...
                        client.publish(f"{MQTT_BASE}/{n}/state/on", json.dumps({"on": bool(on), "brightness": bri}), retain=True)
                        client.publish(f"{MQTT_BASE}/{n}/state/brightness", str(bri), retain=True)
                    else:
